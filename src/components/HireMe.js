...
const HireMe = () => {
  return (
	<div className=' fixed md:absolute right-6 top-1/3 md:top-0 md:left-auto md:bottom-auto  flex items-center justify-center overflow-hidden'>
